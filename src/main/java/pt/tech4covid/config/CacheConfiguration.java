...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, pt.tech4covid.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, pt.tech4covid.repository.UserRepository.USERS_BY_EMAIL_CACHE);
